...
public class GuiSystem {
	...
	private TaxpayerAcountsManager acountsManager = new TaxpayerAcountsManager();
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					GuiSystem window = new GuiSystem();
...
// Save Taxpayer ===========================================================================
	...
	private void showTaxpayerInfo(){
		...
		/*
		panel = new JPanel();
		panel.setBounds(-10008, -10031, 434, 261);
		frame.getContentPane().add(panel);
		panel.setLayout(null);
		panel.setVisible(false);
		
		JTextArea textArea = new JTextArea();
		textArea.setBounds(10, 11, 414, 192);
		...
		btnNewButton.setBounds(45, 214, 126, 36);
		...
		btnNewButton_1.setBounds(252, 214, 126, 36);
	...
	private void showMainMenu(){
		...
		panelShowMainMenu.setBounds(-10008, -10031, 434, 261);
		...
		btnDeleteTaxpayer.setBounds(146, 190, 139, 48);
		...
		btnLoadTaxpayer.setBounds(146, 44, 139, 48);
		panelShowMainMenu.add(btnLoadTaxpayer);
		btnChooseTaxpayer.setBounds(146, 118, 139, 48);
		panelShowMainMenu.add(btnChooseTaxpayer);
	}
	
	private void loadTaxpayer(){
		panelLoadTaxpayer = new JPanel();
		panelLoadTaxpayer.setBounds(-10008, -10031, 434, 261);
		frame.getContentPane().add(panelLoadTaxpayer);
		panelLoadTaxpayer.setLayout(null);
		panelLoadTaxpayer.setVisible(false);
		
		textFieldFilePath = new JTextField();
		textFieldFilePath.setBounds(27, 61, 379, 56);
		panelLoadTaxpayer.add(textFieldFilePath);
		textFieldFilePath.setColumns(10);
		
		JLabel lblEnterTaxpayeData = new JLabel("Enter taxpaye's data file's path");
		lblEnterTaxpayeData.setBounds(130, 11, 158, 39);
		panelLoadTaxpayer.add(lblEnterTaxpayeData);

		//TODO delete terminals outputs
		JButton btnLoad = new JButton("LOAD");
		btnLoad.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				filePath = textFieldFilePath.getText();
				//JOptionPane.showMessageDialog(null, filePath);
				acountsManager.insertTaxpayerFromFile(filePath);
	...
	private void saveTaxpayer(){
		...
		panelSaveTaxpayer.setBounds(-10008, -10031, 434, 261);
		...
		btnSaveFromSaveTaxpayer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(chckbxTxt.isSelected()){
					acountsManager.creatLogTextFile(chosenTaxpayer);
				}
				if(chckbxXml.isSelected()){
					acountsManager.creatLogXmlFile(chosenTaxpayer);
				}
				panelChosenTaxpayerMenu.setVisible(true);
				panelSaveTaxpayer.setVisible(false);
			}
		...
		btnExitFromSaveTaxpayerPanel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panelChosenTaxpayerMenu.setVisible(true);
				panelSaveTaxpayer.setVisible(false);
			}
	...
	private void deleteReceipt(){
		...
		panelDeleteReceipt.setBounds(-10008, -10031, 434, 261);
		frame.getContentPane().add(panelDeleteReceipt);
		panelDeleteReceipt.setLayout(null);
		panelDeleteReceipt.setVisible(false);
		
		JLabel lblNewLabel_1 = new JLabel("Enter receipt's ID for deletion");
		...
		//complete
		JButton btnDeleteReceiptFromDeleteReceiptPanel = new JButton("DELETE RECEIPT");
		btnDeleteReceiptFromDeleteReceiptPanel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				receiptCode = Integer.parseInt(textFieldReceiptForDelete.getText());
				acountsManager.deleteReceiptFromTaxpayer(chosenTaxpayer, receiptCode);
				acountsManager.creatInfoTextFile(chosenTaxpayer);
				panelChosenTaxpayerMenu.setVisible(true);
				panelDeleteReceipt.setVisible(false);
			}
		});
		btnDeleteReceiptFromDeleteReceiptPanel.setBounds(50, 163, 148, 62);
		panelDeleteReceipt.add(btnDeleteReceiptFromDeleteReceiptPanel);

		//complete
		JButton btnExitFromDeleteReceiptPanel = new JButton("EXIT");
		btnExitFromDeleteReceiptPanel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panelChosenTaxpayerMenu.setVisible(true);
				panelDeleteReceipt.setVisible(false);
			}
	...
	private void chosenTaxpayerMenu(){
		...
		panelChosenTaxpayerMenu.setBounds(-10008, -10031, 434, 261);
		...
		btnAddNewReceipt.setBounds(123, 11, 179, 33);
		...
		btnDeleteReceipt.setBounds(123, 140, 179, 33);
		...
		btnShowReport.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				acountsManager.creatBarChart(chosenTaxpayer);
				acountsManager.creatPieChart(chosenTaxpayer);
			}
		});
		btnShowReport.setBounds(123, 52, 179, 33);
		panelChosenTaxpayerMenu.add(btnShowReport);
		
		//complete
		JButton btnDeleteCurrentTaxpayer = new JButton("DELETE CURRENT TAXPAYER");
		btnDeleteCurrentTaxpayer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				acountsManager.deleteTaxpayer(chosenTaxpayer);
				JOptionPane.showMessageDialog(null, "Current taxpayer successfully deleted");
				panelShowMainMenu.setVisible(true);
				panelChosenTaxpayerMenu.setVisible(false);
			}
		});
		btnDeleteCurrentTaxpayer.setBounds(123, 96, 179, 33);
		panelChosenTaxpayerMenu.add(btnDeleteCurrentTaxpayer);

		//complete
		JButton btnExitFromChosenTaxpayerMenu = new JButton("EXIT");
		btnExitFromChosenTaxpayerMenu.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				panelShowMainMenu.setVisible(true);
				panelChosenTaxpayerMenu.setVisible(false);
			}
		...
		btnSaveTaxpayer.setBounds(123, 184, 179, 33);
	...
	private void addReceipt(){
		...
		panelAddReceipt.setBounds(-10008, -10031, 434, 261);
		...
		//complete
		JButton btnAddReceiptFromAddReceiptPanel = new JButton("ADD RECEIPT");
		btnAddReceiptFromAddReceiptPanel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				category = textFieldKind.getText();
				receiptCode = Integer.parseInt(textFieldID.getText());
				dateOfIssue = Integer.parseInt(textFieldDate.getText());
				amountPaid = Integer.parseInt(textFieldAmount.getText());
				...
				streetNumber = Integer.parseInt(textFieldNumber.getText());
				acountsManager.insertNewReceiptForTaxpayer(chosenTaxpayer, category, receiptCode,
						dateOfIssue, amountPaid, companyName, country, city, street, streetNumber);
				acountsManager.creatInfoTextFile(chosenTaxpayer);
				acountsManager.creatInfoXmlFile(chosenTaxpayer);
				//acountsManager.creatInfoTextFile(chosenTaxpayer);
				panelChosenTaxpayerMenu.setVisible(true);
				panelAddReceipt.setVisible(false);
			}
		...
		btnExitFromAddReceiptPanel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				panelChosenTaxpayerMenu.setVisible(true);
				panelAddReceipt.setVisible(false);
			}
	...
	private void chooseTaxpayer(){
		...
		panelChooseTaxpayer.setBounds(-10008, -10031, 434, 261);
		...
		JLabel lblEnterTaxpayersAfm = new JLabel("Enter taxpayer's AFM");
		lblEnterTaxpayersAfm.setBounds(164, 11, 145, 18);
		panelChooseTaxpayer.add(lblEnterTaxpayersAfm);

		//TODO print chosen taxpayer's info
		JButton btnGetTaxpayer = new JButton("GET TAXPAYER");
		btnGetTaxpayer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				chosenTaxpayer = acountsManager.getTaxpayer(Integer.parseInt(textFieldTaxpayerAfm.getText()));
				if (chosenTaxpayer == null){
					JOptionPane.showMessageDialog(null, "Can't find such taxpayer!");
				}else{
					panelChosenTaxpayerMenu.setVisible(true);
					panelChooseTaxpayer.setVisible(false);
				}
	...
	private void deleteTaxpayer(){
		...
		panelDeleteTaxpayer.setBounds(-10008, -10031, 434, 261);
		...
		//complete
		JButton btnDeleteTaxpayerFromDeleteTaxpayer = new JButton("DELETE TAXPAYER");
		btnDeleteTaxpayerFromDeleteTaxpayer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				receiptCode = Integer.parseInt(textFieldDeleteTaxpayer.getText());
				acountsManager.deleteTaxpayer(receiptCode);
				panelShowMainMenu.setVisible(true);
				panelDeleteTaxpayer.setVisible(false);
			}
		});
		btnDeleteTaxpayerFromDeleteTaxpayer.setBounds(31, 165, 152, 59);
		panelDeleteTaxpayer.add(btnDeleteTaxpayerFromDeleteTaxpayer);
		
		//complete
		JButton btnExitFromDeleteTaxpayer = new JButton("EXIT");
		btnExitFromDeleteTaxpayer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				panelShowMainMenu.setVisible(true);
				panelDeleteTaxpayer.setVisible(false);
			}
		...
		JLabel lblNewLabel_10 = new JLabel("Enter taxpayer's AFM for deletion");
