...
public class TaxpayerAccountsManager {
	...
	public void insertNewReceiptForTaxpayer(Taxpayer taxpayerNeedingNewReceipt, String category, int receiptCode, int dateOfIssue, int amountPaid, String companyName, String country, String city, String street, int streetNumber){
