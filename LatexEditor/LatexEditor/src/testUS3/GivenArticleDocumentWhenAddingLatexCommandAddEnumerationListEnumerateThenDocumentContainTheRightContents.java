...
public class GivenArticleDocumentWhenAddingLatexCommandAddEnumerationListEnumerateThenDocumentContainTheRightContents {
	...
	public void initialize() {
		...
		textToBeReplaced = "<-->";
		newContents = "\\begin{enumerate}\n" +
				"\\item\n" + "\\item\n" + "\\end{enumerate}\n";
		latexCommandID = "AddEnumerationListEnumerate";
