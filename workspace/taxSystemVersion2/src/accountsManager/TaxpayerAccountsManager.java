...
public class TaxpayerAccountsManager {
	...
	public void deleteReceiptFromTaxpayer(
		...
		ArrayList<Receipt> receipts =
				taxpayerNeedingToDeleteReceipt.getReceipts();
	...
	public void insertTaxpayerFromFile(String filePath){
		if(filePath.endsWith(".txt")){
			inputManager.createTaxpayerDataListFromTextFile(filePath);
		}else if(filePath.endsWith(".xml")){
			inputManager.createTaxpayerDataListFromXmlFile(filePath);
		}
		taxpayersList.add(inputManager.getTaxpayerFromFileDataList());
	}
	
	public void updateInfoFiles(Taxpayer taxp){
		outputManager.updateInfoFiles(taxp);
	}
	
	public void createLogXmlFile(Taxpayer taxp){
		outputManager.createLogXmlFile(taxp);
	}
	
	public void createLogTextFile(Taxpayer taxp){
		outputManager.createLogTextFile(taxp);
	}
	
	public void createBarChart(Taxpayer taxp){
		outputManager.createBarChart(taxp);
	}
	
	public void createPieChart(Taxpayer taxp){
		outputManager.createPieChart(taxp);
	}
