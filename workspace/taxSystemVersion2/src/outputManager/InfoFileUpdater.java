...
public class InfoFileUpdater {
	...
	public InfoFileUpdater(Taxpayer outputManagerTaxpayer,
			String domain){
	...
	private void createInfoTextFile(){
	...
	private void createInfoXmlFile(){
	...
	private void completeBunchOfDataForXmlFile(){
		...
		bunchOfDataForXmlFile.remove("<Receipts>  </Receipts>");
	}
