...
public class OutputManager {
	...
	public void creatPieChart(Taxpayer taxp){
		...
		pieDataset.setValue("Entertainment; " + taxp.getCategoryReceiptAmountPaid("Entertainment"),
				taxp.getCategoryReceiptAmountPaid("Entertainment"));
		pieDataset.setValue("Basic; " + taxp.getCategoryReceiptAmountPaid("Basic"),
				taxp.getCategoryReceiptAmountPaid("Basic"));
		pieDataset.setValue("Travel; " + taxp.getCategoryReceiptAmountPaid("Travel"),
				taxp.getCategoryReceiptAmountPaid("Travel"));
		pieDataset.setValue("Health; " + taxp.getCategoryReceiptAmountPaid("Health"),
				taxp.getCategoryReceiptAmountPaid("Health"));
		pieDataset.setValue("Other; " + taxp.getCategoryReceiptAmountPaid("Other"),
	...
	public void creatBarChart(Taxpayer taxp){
		...
		JFreeChart chart = ChartFactory.createBarChart("", "", "Tax analysis in $", dataset);
