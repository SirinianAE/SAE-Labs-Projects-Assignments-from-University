...
#Create a Telnet traffic source (telnet0) and attach it to tcp1 <Filled>
set telnet0 [new Application/Telnet]
$telnet0 attach-agent $tcp1
########################################################################

#Create a Null TCP agent (null1), acting as traffic sink <Filled>
...
#Create a UDP connection from node 0 to node 2 <Filled>
...
#Schedule event ftp0 to start at 0.5 secs and to stop at 3.5 secs <Filled>
$ns at 0.5 "$ftp0 start"
$ns at 3.5 "$ftp0 stop"
########################################################################

#Schedule event telnet0 to start at 1.0 secs and to stop at 4.0 secs <Filled>
$ns at 1.0 "$telnet0 start"
$ns at 4.0 "$telnet0 stop"
########################################################################

#Schedule event cbr0 to start at 1.5 secs and to stop at 5.0 secs <Filled>
...
proc finish {} {
	...
	$ns flush-trace
	close $nf
	exec /usr/local/bin/nam lab1_2.nam &
	exit 0
	}
########################################################################
