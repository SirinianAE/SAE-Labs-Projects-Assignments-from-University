...
public class Taxpayer {
	...
	private ArrayList<Double> percentageForSingleTaxpayer =
			new ArrayList<Double>();
	private ArrayList<Double>
	percentageForMarriedFilingSeparatelyTaxpayer = 
	new ArrayList<Double>();
	private ArrayList<Double> 
	percentageForMarriedFilingJointlyTaxpayer =
	new ArrayList<Double>();
	private ArrayList<Double> percentageForHeadOfHouseholdTaxpayer =
			new ArrayList<Double>();
	private ArrayList<Double> borderOfTaxForSingleTaxpayer =
			new ArrayList<Double>();
	private ArrayList<Double>
	borderOfTaxForMarriedFilingSeparatelyTaxpayer =
	new ArrayList<Double>();
	private ArrayList<Double>
	borderOfTaxForMarriedFilingJointlyTaxpayer = 
	new ArrayList<Double>();
	private ArrayList<Double>
	borderOfTaxForHeadOfHouseholdTaxpayer =
	new ArrayList<Double>();
	private ArrayList<Double> staticTaxForSingleTaxpayer = 
			new ArrayList<Double>();
	private ArrayList<Double>
	staticTaxForMarriedFilingSeparatelyTaxpayer =
	new ArrayList<Double>();
	private ArrayList<Double>
	staticTaxForMarriedFilingJointlyTaxpayer =
	new ArrayList<Double>();
	private ArrayList<Double> staticTaxForHeadOfHouseholdTaxpayer =
			new ArrayList<Double>();
	private ArrayList<Double> borderForTaxIncrease =
			new ArrayList<Double>();
	private ArrayList<Double> percentageForTaxIncrease = 
			new ArrayList<Double>();
	...
	initializeBorderOfTaxForMarriedFilingSeparatelyTaxpayer(){
		...
		borderOfTaxForMarriedFilingSeparatelyTaxpayer.add(
				Double.MAX_VALUE);
	}
	...
	initializeBorderOfTaxForMarriedFilingJointlyTaxpayer(){
		...
		borderOfTaxForMarriedFilingJointlyTaxpayer.add(
				Double.MAX_VALUE);
	}
	...
	private double computeTaxIncrease(int categoryNumber){
		return percentageForTaxIncrease.get(categoryNumber)*basicTax /
				100;
	}
