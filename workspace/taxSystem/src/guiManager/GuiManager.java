...
public class GuiManager {
	...
	private TaxpayerAccountsManager accountsManager = new TaxpayerAccountsManager();
	...
	private void setOutputFile(){
		...
		frame.getContentPane().add(panelSetOutputFilePath, "name_1030804165165594");
		...
		JButton btnChooseFileFromSetOutputPathPanel = new JButton("CHOOSE FILE");
		btnChooseFileFromSetOutputPathPanel.addActionListener(new ActionListener() {
		...
		btnChooseFileFromSetOutputPathPanel.setBounds(139, 167, 145, 45);
		panelSetOutputFilePath.add(btnChooseFileFromSetOutputPathPanel);
		
		JLabel lblNewLabel_11 = new JLabel("Enter output file's path");
	...
	private void createDirectoryIfNeeded(String directoryName)
	{
	  ...
	  {
		  JOptionPane.showMessageDialog(null, "Can't locate directory's path");
		  System.exit(-1);
	  }
	}
	...
	private void showReport(){
		...
		frame.getContentPane().add(panelShowReport, "name_981382272378719");
		...
		btnShowChart.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				accountsManager.creatBarChart(chosenTaxpayer);
				accountsManager.creatPieChart(chosenTaxpayer);
	...
	private void showTaxpayerInfo(){
		...
		frame.getContentPane().add(scrollPane, "name_730639875189510");
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				chosenTaxpayer.createTaxpayerInformationString();
				textPane.setText(chosenTaxpayer.getTaxpayerInformationString());
			}
		});
	}
	...
	private void showMainMenu(){
		...
		frame.getContentPane().add(panelShowMainMenu, "name_723228577274520");
	...
	private void loadTaxpayer(){
		...
		frame.getContentPane().add(panelLoadTaxpayer, "name_723228625387284");
	...
	private void saveTaxpayer(){
		...
		frame.getContentPane().add(panelSaveTaxpayer, "name_723228821548180");
		...
		btnSaveFromSaveTaxpayer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				if(chckbxTxt.isSelected()){
					accountsManager.creatLogTextFile(chosenTaxpayer);
				}
				if(chckbxXml.isSelected()){
					accountsManager.creatLogXmlFile(chosenTaxpayer);
				}
				panelChosenTaxpayerMenu.setVisible(true);
				panelSaveTaxpayer.setVisible(false);
			}
	...
	private void deleteReceipt(){
		...
		frame.getContentPane().add(panelDeleteReceipt, "name_723228783398802");
		...
		btnDeleteReceiptFromDeleteReceiptPanel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				accountsManager.deleteReceiptFromTaxpayer(chosenTaxpayer, receiptCode);
				accountsManager.creatInfoTextFile(chosenTaxpayer);
				accountsManager.creatInfoXmlFile(chosenTaxpayer);
				panelChosenTaxpayerMenu.setVisible(true);
				panelDeleteReceipt.setVisible(false);
			}
		});
	...
	private void chosenTaxpayerMenu(){
		...
		frame.getContentPane().add(panelChosenTaxpayerMenu, "name_723228713281209");
	...
	private void addReceipt(){
		...
		frame.getContentPane().add(panelAddReceipt, "name_723228748503867");
		...
		btnAddReceiptFromAddReceiptPanel.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				accountsManager.insertNewReceiptForTaxpayer(chosenTaxpayer, category, receiptCode,
	...
	private void chooseTaxpayer(){
		...
		frame.getContentPane().add(panelChooseTaxpayer, "name_723228670069488");
		...
		btnGetTaxpayer.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				chosenTaxpayer = accountsManager.getTaxpayer(Integer.parseInt(textFieldTaxpayerAfm.getText()));
	...
	private void deleteTaxpayer(){
		...
		frame.getContentPane().add(panelDeleteTaxpayer, "name_723228522571934");
